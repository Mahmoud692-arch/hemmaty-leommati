...
- المحركات الديناميكية: upsert_dynamic_content, upsert_program, upsert_form, upsert_taxonomy, upsert_automation, upsert_achievement_rule
- إدارة عامة: adjust_points, upsert_ad, upsert_page
...
const SENSITIVE_OPS = new Set([
  ...
  // New engines — any modification requires confirmation
  ...
  "grant_badge", "revoke_badge", "bulk_import_articles", "upsert_quote",
]);
